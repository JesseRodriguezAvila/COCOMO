...
def cocomo(table, kloc):
    ...
    print("     E = a * (KLOC^b) = {} * {}^({}) = {}".format(a, kloc, b, effort))

    print("\n-- Development Time = {} Months".format(round(time)))
    print("     time = c * (effort)^d = {} * ({})^{} = {}".format(c, effort, d, time) )
    
    print("\n-- Average Staff Required = {} Persons".format(round(staff_required)))
    print("     AvgStaffReq = effort / time = {} / {} = {}\n".format(effort, time, staff_required))
